...
var computeRooted = (function () {
    ...
    return computeRooted;
}());
///

var computeRootless = (function () {
    ...
    var runRootless1 = function (state0, trusts) {
        ...
        trusts.forEach(function (t) {
            ...
            if (n.totalOutgoingTrust > highestTotalTrust) {
                highestTotalTrust = n.totalOutgoingTrust;
            }
        });
    ...
    var computeRootless = function (parsed, cb) {
        ...
        cb(undefined, karmasToList(runRootless1(karmas, trusts)));
    };
